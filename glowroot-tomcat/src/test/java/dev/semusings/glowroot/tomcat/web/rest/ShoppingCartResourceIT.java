...
import static dev.semusings.glowroot.tomcat.domain.ShoppingCartAsserts.*;
import static dev.semusings.glowroot.tomcat.web.rest.TestUtil.createUpdateProxyForBean;
import static dev.semusings.glowroot.tomcat.web.rest.TestUtil.sameNumber;
...
import dev.semusings.glowroot.tomcat.domain.CustomerDetails;
import dev.semusings.glowroot.tomcat.domain.ShoppingCart;
import dev.semusings.glowroot.tomcat.domain.enumeration.OrderStatus;
import dev.semusings.glowroot.tomcat.domain.enumeration.PaymentMethod;
import dev.semusings.glowroot.tomcat.repository.ShoppingCartRepository;
