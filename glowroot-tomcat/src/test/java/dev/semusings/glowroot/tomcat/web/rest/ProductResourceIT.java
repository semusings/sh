...
import static dev.semusings.glowroot.tomcat.domain.ProductAsserts.*;
...
import dev.semusings.glowroot.tomcat.domain.Product;
import dev.semusings.glowroot.tomcat.domain.ProductCategory;
import dev.semusings.glowroot.tomcat.domain.enumeration.Size;
import dev.semusings.glowroot.tomcat.repository.ProductRepository;
import dev.semusings.glowroot.tomcat.service.ProductService;
...
class ProductResourceIT {
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.price(UPDATED_PRICE).productSize(UPDATED_PRODUCT_SIZE);
