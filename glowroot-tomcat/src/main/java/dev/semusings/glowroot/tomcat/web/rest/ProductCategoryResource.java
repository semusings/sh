...
import dev.semusings.glowroot.tomcat.repository.ProductCategoryRepository;
import dev.semusings.glowroot.tomcat.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link dev.semusings.glowroot.tomcat.domain.ProductCategory}.
 */
@RestController
...
public class ProductCategoryResource {
    ...
    public ResponseEntity<ProductCategory> createProductCategory(@Valid @RequestBody ProductCategory productCategory)
        ...
        return ResponseEntity.created(new URI("/api/product-categories/" + productCategory.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, productCategory.getId().toString()))
