...
/**
 * REST controller for managing {@link dev.semusings.glowroot.tomcat.domain.ProductOrder}.
 */
@RestController
...
public class ProductOrderResource {
    ...
    public ResponseEntity<ProductOrder> createProductOrder(@Valid @RequestBody ProductOrder productOrder) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/product-orders/" + productOrder.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, productOrder.getId().toString()))
            .body(productOrder);
    }
